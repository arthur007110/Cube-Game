...
draw_text_transformed(room_width/2.2, room_height/1.75,"Alpha!", text_size/4, text_size/4, text_angle);
...
draw_text_transformed(20, room_height - 60, "Game Version: " + string(GM_version) + "alpha", 0.3, 0.3, 0);